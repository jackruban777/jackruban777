...
> **Building intelligent applications • Exploring modern technologies • Creating immersive web experiences**
...
`SOFTWARE DEVELOPMENT` · `JAVA` · `PYTHON` · `WEB` · `AI` · `CLOUD`
...
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&size=15&duration=2800&pause=900&color=00D9FF&center=true&vCenter=true&width=340&lines=Writing+Clean+Code;Building+Real+Applications;Exploring+Modern+Technology;Learning+Every+Day" />
...
<p>
<img src="https://img.shields.io/badge/APIs-111111?style=flat-square&logo=fastapi&logoColor=00D9FF" />
...
Interactive 3D websites built using modern web technologies with immersive interfaces and smooth motion.
...
Complete applications from intuitive interfaces to reliable backend systems.
